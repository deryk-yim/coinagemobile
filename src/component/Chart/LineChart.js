...
import { Svg, Text, TSpan, Circle, Polygon, Polyline, Path, Rect } from 'react-native-svg'
        ...
        return ( <View style = {style}>
                        <Svg height = {height} width = {width}>
                            ...
                            <Rect width = "100%"
                                ...
                                fill = "rgba(0,0,0,0)"
                            /> 
                            { this.renderHorizontalLines({ ...config, count: 4, paddingTop, paddingRight })} 
                            
                            { this.renderVerticalLabels({ ...config, labels, paddingRight, paddingTop })} 
...
/*
{ this.renderLine({ ...config, paddingRight, paddingTop, data: data.datasets })} 
                            { withShadow && this.renderShadow({ ...config, data: data.datasets, paddingRight, paddingTop})} 
                            { withDots && this.renderDots({ ...config, data: data.datasets, paddingTop, paddingRight })} 
*/
/*
